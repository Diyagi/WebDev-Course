// Creates pagination controls and manages their state.
export function createPagination(body, onChange) {
  ...
  // Updates the pagination labels and buttons.
  function render() {
